...
function buildDashboardBottomNav() {
  ...
  return `
    <nav class="bottom-nav" id="bottom-nav">
      ...
      <button class="bottom-nav-btn" id="bottom-create-btn" onclick="toggleDropdown(document.getElementById('create-menu'))">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/></svg>
        Create
      </button>
